...
public class Keys {
    ...
    public static final UniqueKey<ReportsRecord> REPORTS_USERID_KEY = Internal.createUniqueKey(Reports.REPORTS, DSL.name("reports_userid_key"), new TableField[] { Reports.REPORTS.USERID }, true);
    ...
    public static final UniqueKey<UsersRecord> USERS_GUILDID_KEY = Internal.createUniqueKey(Users.USERS, DSL.name("users_guildid_key"), new TableField[] { Users.USERS.GUILDID }, true);
    public static final UniqueKey<UsersRecord> USERS_PKEY = Internal.createUniqueKey(Users.USERS, DSL.name("users_pkey"), new TableField[] { Users.USERS.ID }, true);
    public static final UniqueKey<UsersRecord> USERS_USERID_KEY = Internal.createUniqueKey(Users.USERS, DSL.name("users_userid_key"), new TableField[] { Users.USERS.USERID }, true);
    ...
    public static final ForeignKey<RemindersRecord, UsersRecord> REMINDERS__REMINDERS_USERID_FKEY = Internal.createForeignKey(Reminders.REMINDERS, DSL.name("reminders_userid_fkey"), new TableField[] { Reminders.REMINDERS.USERID }, Keys.USERS_USERID_KEY, new TableField[] { Users.USERS.USERID }, true);
    ...
    public static final ForeignKey<ReportsRecord, UsersRecord> REPORTS__REPORTS_USERID_FKEY = Internal.createForeignKey(Reports.REPORTS, DSL.name("reports_userid_fkey"), new TableField[] { Reports.REPORTS.USERID }, Keys.USERS_USERID_KEY, new TableField[] { Users.USERS.USERID }, true);
    ...
    public static final ForeignKey<UsersRecord, GuildsRecord> USERS__USERS_GUILDID_FKEY = Internal.createForeignKey(Users.USERS, DSL.name("users_guildid_fkey"), new TableField[] { Users.USERS.GUILDID }, Keys.GUILDS_PKEY, new TableField[] { Guilds.GUILDS.GUILDID }, true);
    ...
    public static final ForeignKey<WarningsRecord, UsersRecord> WARNINGS__WARNINGS_USERID_FKEY = Internal.createForeignKey(Warnings.WARNINGS, DSL.name("warnings_userid_fkey"), new TableField[] { Warnings.WARNINGS.USERID }, Keys.USERS_USERID_KEY, new TableField[] { Users.USERS.USERID }, true);
}
