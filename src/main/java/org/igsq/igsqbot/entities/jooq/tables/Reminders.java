...
public class Reminders extends TableImpl<RemindersRecord> {
    ...
    public List<ForeignKey<RemindersRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<RemindersRecord, ?>>asList(Keys.REMINDERS__REMINDERS_GUILDID_FKEY, Keys.REMINDERS__REMINDERS_USERID_FKEY);
    }
    ...
    public Users users() {
        return new Users(this, Keys.REMINDERS__REMINDERS_USERID_FKEY);
    }
