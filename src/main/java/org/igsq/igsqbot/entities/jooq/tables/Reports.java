...
public class Reports extends TableImpl<ReportsRecord> {
    ...
    public List<UniqueKey<ReportsRecord>> getKeys() {
        return Arrays.<UniqueKey<ReportsRecord>>asList(Keys.REPORTS_PKEY, Keys.REPORTS_MESSAGEID_KEY, Keys.REPORTS_REPORTMESSAGEID_KEY, Keys.REPORTS_CHANNELID_KEY, Keys.REPORTS_USERID_KEY);
    }

    @Override
    public List<ForeignKey<ReportsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<ReportsRecord, ?>>asList(Keys.REPORTS__REPORTS_GUILDID_FKEY, Keys.REPORTS__REPORTS_USERID_FKEY);
    }
    ...
    public Users users() {
        return new Users(this, Keys.REPORTS__REPORTS_USERID_FKEY);
    }
