...
public class Warnings extends TableImpl<WarningsRecord> {
    ...
    public List<ForeignKey<WarningsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<WarningsRecord, ?>>asList(Keys.WARNINGS__WARNINGS_GUILDID_FKEY, Keys.WARNINGS__WARNINGS_USERID_FKEY);
    }
    ...
    public Users users() {
        return new Users(this, Keys.WARNINGS__WARNINGS_USERID_FKEY);
    }
