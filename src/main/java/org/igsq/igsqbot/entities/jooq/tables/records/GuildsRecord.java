...
public class GuildsRecord extends UpdatableRecordImpl<GuildsRecord> implements Record11<Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, String> {
    ...
    @Override
    public Row11<Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, String> valuesRow() {
    ...
    @Override
    public GuildsRecord value11(String value) {
        setPrefix(value);
        return this;
    }

    @Override
    public GuildsRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, Long value6, Long value7, Long value8, Long value9, Long value10, String value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GuildsRecord(Long guildId, Long logChannel, Long mutedRole, Long verifiedRole, Long reportChannel, Long voteChannel, Long suggestionChannel, Long selfPromoChannel, Long selfPromoRole, Long levelUpBot, String prefix) {
        super(Guilds.GUILDS);
