...
public class MessageGenerator 
{
	...
	/**
	 * Adds a reaction to the message which is done after the message has been sent. The reactions can be retrieved at any time using {@link #getReactions()}. If more than {@link EmbedUtils#REACTION_LIMIT} reactions exist they will be ignored.
	...
	/**
	 * Adds an array of reactions to the message which is done after the message has been sent. The reactions can be retrieved at any time using {@link #getReactions()}. If more than {@link EmbedUtils#REACTION_LIMIT} reactions exist they will be ignored.
